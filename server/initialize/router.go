...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitSport_scoreRouter(PrivateGroup)
		router.InitSportRouter(PrivateGroup)
		router.InitSportProvinceRouter(PrivateGroup)
		router.InitSportCityRouter(PrivateGroup)
		router.InitSportSchoolRouter(PrivateGroup)
		router.InitSportStudentRouter(PrivateGroup)
		router.InitSportStudentScoreRouter(PrivateGroup)
